...
fn main() {
    ...
    if target.ends_with("-android") {
        physx_cc.flag("--sysroot=/home/viktor/android-ndk-r21b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/");
    }
    ...
    let include_path = if env::var("CARGO_FEATURE_STRUCTGEN").is_ok() {
        ...
        if target.ends_with("-android") {
            // for -lc++
            cmd.arg("-L/home/viktor/android-ndk-r21b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/lib/aarch64-linux-android/29/");
            ...
            cmd.arg("/home/viktor/android-ndk-r21b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/lib/aarch64-linux-android/29/crtbegin_static.o");
            cmd.arg("/home/viktor/android-ndk-r21b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/lib/aarch64-linux-android/29/crtend_android.o");
        }
